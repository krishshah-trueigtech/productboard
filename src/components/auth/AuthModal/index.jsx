...
const AuthModal = () => {
    ...
    return (
      <Modal isOpen={state.isOpen} onClose={() => dispatch({ type: "CLOSE_MODAL" })}>
        <div className="p-6 w-[400px]">
          <h2 className="text-2xl font-bold mb-4 text-center">{viewConfig.title}</h2>
          ...
          <AuthForm 
            ...
            onSubmit={(data) => {
               console.log(`Submitting ${state.view}:`, data);
